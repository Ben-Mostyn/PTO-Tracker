...
interface MyProps {
  dateOne: Date;
  setDateOne: React.Dispatch<React.SetStateAction<Date | undefined>>;
  dateTwo: Date;
  setDateTwo: React.Dispatch<React.SetStateAction<Date | undefined>>;
  datesBooked: any;
  setDatesBooked: React.Dispatch<any>;
  bookBoolean: Boolean;
  setBookBoolean: React.Dispatch<React.SetStateAction<Boolean>>;
  data: any;
